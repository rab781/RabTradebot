...
| `BINANCE_API_SECRET` | `string` | None | Required for live trading and better rate limits. The bot automatically falls back to the public Binance API if private credentials are not provided. |
