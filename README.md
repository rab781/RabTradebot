...
The bot includes a built-in REST API for accessing trading data, bot state, and health metrics.
See the [full API reference →](docs/API_REFERENCE.md) for details on endpoints, responses, and rate limits.
