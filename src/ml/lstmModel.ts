    ...
    private featuresToArray(features: FeatureSet[]): number[][] {
        return features.map(f => {
            ...
            const rawFeatures = [
                ...
                f.ema_9, f.ema_21, f.ema_50, f.sma_20, f.sma_50, f.sma_200,
                f.adx, f.priceVsEMA9, f.priceVsEMA21, f.priceVsSMA50,
                f.atr_14, f.atrPercent, f.bb_upper, f.bb_middle, f.bb_lower, f.bb_width, f.bb_percentB,
                f.volumeRatio, f.volumeMA_20, f.obv, f.obvSlope, f.volumePriceCorrelation, f.volumeWeightedPrice, f.moneyFlowIndex,
                f.volatility_20, f.volatility_50, f.skewness_20, f.kurtosis_20,
