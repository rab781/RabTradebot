declare module 'cryptocompare' {
    ...
    export function priceMulti(fsyms: string[], tsyms: string[]): Promise<{ [key: string]: { [key: string]: number } }>;
    export function priceFull(fsyms: string[], tsyms: string[]): Promise<any>;
    export function priceHistorical(fsym: string, tsyms: string[], options?: { timestamp?: number }): Promise<any>;
}
