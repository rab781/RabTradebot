...
app.get('/api/dashboard', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error('Error fetching dashboard data', error);
...
app.get('/api/trades', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error('Error fetching trades', error);
        res.status(500).json({ error: 'Internal server error' });
    }
});
...
app.get('/api/trades/open', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error('Error fetching open trades', error);
        res.status(500).json({ error: 'Internal server error' });
    }
});
...
app.get('/api/signals', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error('Error fetching signals', error);
        res.status(500).json({ error: 'Internal server error' });
    }
});
...
app.get('/api/news', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error('Error fetching news', error);
        res.status(500).json({ error: 'Internal server error' });
    }
});
...
app.get('/api/portfolio', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error('Error fetching portfolio', error);
        res.status(500).json({ error: 'Internal server error' });
    }
});
...
app.get('/api/stats', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error('Error fetching bot stats', error);
        res.status(500).json({ error: 'Internal server error' });
    }
});
