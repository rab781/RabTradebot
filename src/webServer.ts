...
app.get('/api/dashboard', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error({ err: error }, 'Error fetching dashboard data');
...
app.get('/api/trades', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error({ err: error }, 'Error fetching trades');
        res.status(500).json({ error: 'An internal server error occurred' });
    }
});
...
app.get('/api/trades/open', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error({ err: error }, 'Error fetching open trades');
        res.status(500).json({ error: 'An internal server error occurred' });
    }
});
...
app.get('/api/signals', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error({ err: error }, 'Error fetching signals');
        res.status(500).json({ error: 'An internal server error occurred' });
    }
});
...
app.get('/api/news', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error({ err: error }, 'Error fetching news');
        res.status(500).json({ error: 'An internal server error occurred' });
    }
});
...
app.get('/api/portfolio', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error({ err: error }, 'Error fetching portfolio');
        res.status(500).json({ error: 'An internal server error occurred' });
    }
});
...
app.get('/api/stats', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error({ err: error }, 'Error fetching stats');
        res.status(500).json({ error: 'An internal server error occurred' });
    }
});
