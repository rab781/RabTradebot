...
app.get('/api/dashboard', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error('Error getting dashboard data:', error);
...
app.get('/api/trades', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error('Error getting trades:', error);
        res.status(500).json({ error: 'An internal server error occurred' });
    }
});
...
app.get('/api/trades/open', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error('Error getting open trades:', error);
        res.status(500).json({ error: 'An internal server error occurred' });
    }
});
...
app.get('/api/signals', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error('Error getting signals:', error);
        res.status(500).json({ error: 'An internal server error occurred' });
    }
});
...
app.get('/api/news', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error('Error getting news:', error);
        res.status(500).json({ error: 'An internal server error occurred' });
    }
});
...
app.get('/api/portfolio', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error('Error getting portfolio:', error);
        res.status(500).json({ error: 'An internal server error occurred' });
    }
});
...
app.get('/api/stats', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error('Error getting stats:', error);
        res.status(500).json({ error: 'An internal server error occurred' });
    }
});
