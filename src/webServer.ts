...
app.get('/api/dashboard', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error('API Error in /api/dashboard', error);
...
app.get('/api/trades', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error('API Error in /api/trades', error);
        res.status(500).json({ error: 'An internal server error occurred' });
    }
});
...
app.get('/api/trades/open', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error('API Error in /api/trades/open', error);
        res.status(500).json({ error: 'An internal server error occurred' });
    }
});
...
app.get('/api/signals', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error('API Error in /api/signals', error);
        res.status(500).json({ error: 'An internal server error occurred' });
    }
});
...
app.get('/api/news', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error('API Error in /api/news', error);
        res.status(500).json({ error: 'An internal server error occurred' });
    }
});
...
app.get('/api/portfolio', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error('API Error in /api/portfolio', error);
        res.status(500).json({ error: 'An internal server error occurred' });
    }
});
...
app.get('/api/stats', (req: Request, res: Response) => {
    try {
        ...
        withLogContext({ service: 'webServer' }).error('API Error in /api/stats', error);
        res.status(500).json({ error: 'An internal server error occurred' });
    }
});
