...
export class StrategyOptimizer {
    ...
    static analyzeResults(results: StrategyOptimizationResult[]): {
        ...
        // ⚡ Bolt Optimization: Hoist shared array extraction and consolidate statistical metrics
        // into a single O(N) loop to prevent redundant O(N) allocations per parameter and O(2N) reduce passes.
        ...
        const scoreVar = Math.max(0, (sumScoreSq / n) - (avgScore * avgScore));
