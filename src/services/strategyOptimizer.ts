...
export class StrategyOptimizer {
    ...
    static analyzeResults(results: StrategyOptimizationResult[]): {
        ...
        // ⚡ Bolt Optimization: Hoist shared array extractions and consolidate statistical metrics
        // into a single O(N) pass to prevent redundant memory allocations per parameter
        ...
        const variance = Math.max(0, (sumScoreSq / n) - (avgScore * avgScore));
