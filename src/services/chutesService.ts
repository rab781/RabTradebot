          ...
          messages: [
            {
              role: 'system',
              content:
                'You are an expert cryptocurrency market analyst specializing in news impact analysis and price prediction. Always provide accurate, structured data in JSON format.',
            },
            {
              role: 'user',
              content: prompt,
