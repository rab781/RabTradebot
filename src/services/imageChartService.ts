    ...
    private calculateSwingPoints(data: CandleData[]): SwingPoint[] {
        ...
        for (let i = lookback; i < data.length - lookback; i++) {
            ...
            if (isSwingHigh) {
                ...
                swingPoints.push({ index: i, type, price: currentHigh, timestamp: data[i].t, isHigh: true });
            ...
            if (isSwingLow) {
                ...
                swingPoints.push({ index: i, type, price: currentLow, timestamp: data[i].t, isHigh: false });
            ...
            if (head.price > left.price && head.price > right.price) {
                ...
                if (shoulderDiff < 0.03) {
                    ...
                    if (necklineLows.length >= 2) {
                        const neckline = (necklineLows[0].price + necklineLows[necklineLows.length - 1].price) / 2;
                        ...
                        patterns.push({
                            ...
                            points: [
                                ...
                                { index: necklineLows[necklineLows.length - 1].index, price: necklineLows[necklineLows.length - 1].price },
        ...
        const srPlugin: Plugin = {
            ...
            beforeDatasetsDraw: (chart) => {
                ...
                srLevels.forEach(level => {
                    ...
                    const color = level.type === 'resistance' ? 'rgba(246, 70, 93, 0.15)' : 'rgba(14, 203, 129, 0.15)';
                    ...
                    ctx.textAlign = 'left';
                    ctx.fillText(`${level.type.toUpperCase()} (${level.strength}%)`, chartArea.left + 5, y - 10);
                });
